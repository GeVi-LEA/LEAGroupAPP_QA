...
<span id="valor" hidden>Estatus</span>
...
<header class="header">
    <div class="row">
        ...
        <div class="col-6 text-center"><h1 class="titulo">Estatus</h1></div>
...
<nav class="menu">
    <span id="mostrarForm">Agregar estatus</span>
</nav>
<section id="secForm">
    <form action="<?= catalogosUrl ?>?controller=Catalogo&action=saveEstatus" method="post" class="formulario" id="formularioEstatus" >
        ...
        <div class="row p-1 ">
            ...
            <div class="col-9">
                <input type="text" name="clave" class="inputSmall" id="clave" maxlength="10" placeholder="Ej. c"/>
            </div>
        </div>
        <div class="row p-1 ">
            <div class="col-3 text-right">
...
<section class="sec-tabla text-center table-responsive-sm" id="seccionEstatus">
    <table class="table table-condensed" id="tablaEstatus">
        <?php if (!empty($estatus)): ?>
            ...
            <tbody>
                <?php foreach ($estatus as $e): ?>
                    <tr class="tr">
                        <td id="idTabla"><?= $e->id; ?></td>
                        <td id="nombreTabla"><?= $e->nombre; ?></td>
                        <td id="claveTabla"><?= $e->clave; ?></td>
                        <td id="descripcionTabla"><?= $e->descripcion; ?></td>
                        <td> 
                            <div>
                                <a ><span id="edit" class="material-icons i-edit" title="Editar">edit</span></a>                    
                                <a id="linkDelete" href="<?= catalogosUrl ?>?controller=Catalogo&action=deleteEstatus&id=<?= $e->id; ?>" ></a><span id="delete" class="material-icons i-delete" title="Eliminar">delete_forever</span>
                            </div>
                        </td>
                    <?php endforeach; ?>
            </tbody>
    ...
    <?php else: ?>
        <span>No hay estatus registradas</span>                   
    <?php endif; ?>
</section>
