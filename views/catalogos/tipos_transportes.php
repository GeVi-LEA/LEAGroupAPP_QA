...
<header class="header">
    <div class="row">
        ...
        <div class="col-10 text-center"><h1 class="titulo">Tipos de transportes</h1></div>
                    ...
                    <tr class="tr">
                        ...
                        <td> 
                            <div>
                                ...
                                <a id="linkDelete" href="<?= catalogosUrl ?>?controller=Catalogo&action=deleteTipoTransporte&id=<?= $t->id; ?>" ></a><span id="delete" class="material-icons i-delete" title="Eliminar">delete_forever</span>
                            </div>
                        </td>
                    <?php endforeach; ?>
            </tbody>
