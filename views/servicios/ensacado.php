            ...
            <form id="ensacadoForm" enctype="multipart/form-data">
                <div class="div-datos pb-2">
                    ...
                    <div class="datos mt-2 mb-1">
                        ...
                        <div><strong class="mr-1">Número FT/AT:</strong><input type="text" name="numeroUnidad" value="<?= isset($ensacado) ? $ensacado['numUnidad'] : ''; ?>" id="numeroUnidad" class="item-small" />
                            ...
                            <input id="documentoBill" name="documentoBill" type="file" hidden /><input type="hidden" id="archivoBill" name="archivoBill" value="<?= isset($ensacado) && $ensacado['doc_remision'] != '' ? $ensacado['doc_remision'] : ''; ?>">
                        ...
                        <div><strong class="mr-1">Peso cliente:</strong><input type="text" name="pesoCliente" id="pesoCliente" value="<?= isset($ensacado) && $ensacado['peso_cliente'] != null ? UtilsHelp::numero2Decimales($ensacado['peso_cliente']) : ''; ?>" class="item-small" /><span class="ml-1">kgs.</span></div>
                    ...
                    <div class="datos pb-2">
                        <div>
                            ...
                            <input type="text" name="transportista" value="<?= isset($ensacado['transportista']) ? $ensacado['transportista'] : ''; ?>" id="transportista" class="item-big" />
                        </div>
                        ...
                        <div><strong class="mr-1">Tara:</strong><input type="text" name="tara" value="<?= isset($ensacado) && $ensacado['peso_tara'] != null ? UtilsHelp::numero2Decimales($ensacado['peso_tara']) : ''; ?>" id="tara" class="item-small" /><span class="ml-1">lbs.</span></div>
                        <div class="d-flex">
                            <div><strong class="mr-1">Ticket:</strong><input type="text" name="ticket" value="<?= isset($ensacado) ? $ensacado['ticket'] : ''; ?>" id="ticket" class="item-small" />
                                ...
                                <input id="documentoTicket" name="documentoTicket" type="file" hidden /><input type="hidden" id="archivoTicket" name="archivoTicket" value="<?= isset($ensacado) && $ensacado['doc_ticket'] != '' ? $ensacado['doc_ticket'] : ''; ?>">
                                <i id="show" class="i-pdf material-icons fa-solid fa-file-pdf" title="Ver Bill of lading" hidden></i>
                    ...
                    <div class="datos pb-2" <?= $isTren ? 'hidden' : '' ?>>
                        <div><strong class="mr-1">Chofer:</strong><input type="text" name="chofer" value="<?= isset($ensacado['chofer']) ? $ensacado['chofer'] : ''; ?>" id="chofer" class="item-big" <?= $isTren ? 'disabled' : '' ?> /></div>
                    ...
                    <div class="datos pb-2">
                        ...
                        <div><strong class="mr-1">Fecha salida:</strong><input type="text" name="fechaSalida" value="<?= isset($ensacado) && $ensacado['fecha_salida'] != '' ? UtilsHelp::fechaHora($ensacado['fecha_salida']) : ''; ?>" id="fechaSalida" class="item-medium fixed" readOnly disabled /></div>
                    ...
                    <div class="row flex-nowrap pb-3">
                        <div class=" col-4 pl-5">
                            <div class="d-flex justify-content-between mb-1">
                                ...
                                <div class="pr-5"><input type="text" name="taraKilos" value="<?= isset($ensacado) ? UtilsHelp::numero2Decimales($ensacado['pesoTaraKg'], true, 0) : ''; ?>" id="taraKilos" class="item-small fixed" disabled /><span class="ml-1">kgs.</span></div>
                            </div>
                            <div class="d-flex justify-content-between mb-1">
                                <div class="pt-2"><strong>Peso teorico:</strong></div>
                                <div class="pr-5"><input type="text" name="pesoTeorico" value="<?= isset($ensacado) ? UtilsHelp::numero2Decimales($ensacado['peso_teorico'], true, 0) : ''; ?>" id="pesoTeorico" class="item-small fixed" disabled /><span class="ml-1">kgs.</span></div>
                            </div>

                            <div class="d-flex justify-content-between mb-1">
                                <div class="pt-2"><strong>% Tolerable:</strong></div>
                                <div class="pr-5"><input type="text" name="tolerable" value="<?= isset($ensacado) ? UtilsHelp::numero2Decimales($ensacado['tolerable'], true, 0) : ''; ?>" id="tolerable" class="item-small fixed" disabled /><span class="ml-1">kgs.</span></div>
                            </div>
                            <div class="d-flex justify-content-between">
                                <div class="pt-2"><strong title="Diferencia entre peso teorico y peso cliente.">Diferencia teorica:</strong></div>
                                <div class="pr-5"><input type="text" name="diferenciaTeorica" value="<?= isset($ensacado['diferenciaTeorica']) ? UtilsHelp::numero2Decimales($ensacado['diferenciaTeorica'], true, 0) : ''; ?>" id="diferenciaTeorica" class="item-small fixed" disabled /><span class="ml-1">kgs.</span></div>
                            </div>
                        </div>
                        <div class="col-4 pl-5">
                            <div class="d-flex justify-content-between mb-1">
                                <div class="pt-2"><strong>Peso bruto:</strong></div>
                                <div class="pr-5"><input type="text" name="pesoBruto" value="<?= isset($pesaje) ? UtilsHelp::numero2Decimales($pesaje['EntPesoB'], true, 0) : ''; ?>" id="pesoBruto" class="item-small fixed" disabled /><span class="ml-1">kgs.</span></div>
                            </div>
                            <div class="d-flex justify-content-between mb-1">
                                <div class="pt-2"><strong>Peso tara:</strong></div>
                                <div class="pr-5"><input type="text" name="pesoTara" value="<?= isset($pesaje['EntPesoT']) ? UtilsHelp::numero2Decimales($pesaje['EntPesoT'], true, 0) : ''; ?>" id="pesoTara" class="item-small fixed" disabled /><span class="ml-1">kgs.</span></div>
                            </div>
                            <div class="d-flex justify-content-between mb-1">
                        ...
                        <div class="col-4 pl-5">
                            ...
                            <div class="d-flex justify-content-between mb-1">
                                ...
                                <div class="pr-8"><input type="text" name="horaPeso" value="<?= isset($pesaje) ? UtilsHelp::formatoHora($pesaje['EntHoraE']) : ''; ?>" id="horaPeso" class="item-small fixed" disabled /></div>
                            </div>
                            <div class="d-flex justify-content-between mb-1">
                    ...
                    <?php endif; ?>
                    <div class="datos pb-2">
                        <div><strong class="mr-1">Observaciones:</strong><input name="observaciones" class="item-bigger" id="observaciones" type="text" value="<?= isset($ensacado) ? $ensacado['observaciones'] : ''; ?>" /></div>
                    </div>
                </div>
            </form>
        </section>
        <section id="seccionServicios">
            ...
            <div class="div-datos mt-2">
                <div class="d-flex justify-content-between mt-1">
                    ...
                    <div class="ml-2"><strong class="mr-1">Servicio:</strong><input type="hidden" id="idNombreServicio" value="<?= $serv['servicio_id'] ?> " /> <span id="nombreServicio" class="fixed item-medium">
                            <?= $serv['nombreServ'] ?></span></div>
                    <div><strong class="mr-1">Empaque:</strong><span class="fixed item-medium"> <?= $serv['empaque'] ?></span></div>
                    <div><strong class="mr-1">Cantidad:</strong><span class="item-s-small fixed"><?= $serv['cantidad'] != null ? UtilsHelp::numero2Decimales($serv['cantidad']) : ''; ?></span><span class="ml-1">kgs.</span></div>
                    <div>
                ...
                <div class="datos mt-2">
                    ...
                    <div><strong class="mr-1">Fecha programación:</strong><span class="item-small fixed"><?= $serv['fecha_programacion'] != null && $serv['fecha_programacion'] != '' ? date('d/m/Y', strtotime($serv['fecha_programacion'])) : ''; ?></span>
                    </div>
                    <div><strong class="mr-1">Inicio:</strong><span class="item-medium fixed"><?= $serv['fecha_inicio'] != null && $serv['fecha_inicio'] != '' ? UtilsHelp::fechaHora($serv['fecha_inicio']) : ''; ?></span></div>
                ...
                <div class="datos mt-2" style="visible:<?= str_contains($serv['nombreServ'], 'SALIDA') ? 'none' : 'block'; ?>">
                    <div><strong class="mr-1">Total ensacado:</strong><span class="item-small fixed"><?= $serv['total_ensacado'] != null ? UtilsHelp::numero2Decimales($serv['total_ensacado']) : ''; ?></span><span class="ml-1">kgs.</span></div>
                    <div><strong class="mr-1">Barredura sucia:</strong><span class="item-small fixed"><?= $serv['barredura_sucia'] != '' ? UtilsHelp::numero2Decimales($serv['barredura_sucia']) : ''; ?></span><span class="ml-1 mr-3">kgs.</span></div>
                    <div><strong class="mr-1">Barredura limpia:</strong><span class="item-small fixed"><?= $serv['barredura_limpia'] != '' ? UtilsHelp::numero2Decimales($serv['barredura_limpia']) : ''; ?></span><span class="ml-1 mr-3">kgs.</span></div>
                    <div><strong class="mr-1">Total barredura:</strong><span class="item-small fixed"><?= UtilsHelp::string2Entero($serv['barredura_sucia'] + $serv['barredura_limpia']); ?></span><span class="ml-1">kgs.</span></div>
                </div>
                <div class="datos mt-2">
